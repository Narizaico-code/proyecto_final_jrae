-- Administradores (manteniendo los existentes y agregando más)
...
INSERT IGNORE INTO Administradores (nombre, apellido, correo, telefono)
VALUES ('Laura', 'Rodríguez', 'laura.rodriguez@example.com', '88776655');

INSERT IGNORE INTO Administradores (nombre, apellido, correo, telefono)
VALUES ('Pedro', 'López', 'pedro.lopez@example.com', '33445566');

-- Clientes (manteniendo los existentes y agregando más)
